...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{route('admin.update.shipping' , $shipping->id)}}" method="POST" id="EditShippingForm" name="EditShippingForm">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="country" id="country" class="form-control">
                                        ...
                                        @if($countries->isNotEmpty())
                                            ...
                                            @endforeach
                                            <option {{ ($shipping->country_id == 'rest_of_world') ? 'selected' : ''}}   value="rest_of_world">Rest of the World</option>
                                        @endif
                                    </select>
...
@section('customJs')
    <script>
        $('#EditShippingForm').submit(function(e){
            ...
            $.ajax({
                type: "POST",
                url: '{{ route("admin.update.shipping", $shipping->id) }}',
