<ul id="account-panel" class="nav nav-pills flex-column" >
    <li class="nav-item">
        <a href="{{route('frontend.account.profile')}}"  class="nav-link font-weight-bold" role="tab" aria-controls="tab-login" aria-expanded="false"><i class="fas fa-user-alt"></i> My Profile</a>
    </li>
    <li class="nav-item">
   ...
   <li class="nav-item">
    <form method="POST" action="{{ route('frontend.account.logout') }}">
        @csrf
        <button type="submit" role="tab" aria-controls="tab-register"  aria-expanded="false" class="nav-link font-weight-bold">
