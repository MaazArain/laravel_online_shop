	...
	<div class="container">
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			...
			<div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
                ...
                @auth
                <div class="dropdown">
                    <a href="#" class="nav-link text-dark dropdown-toggle" id="accountDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                         {{ Auth::user()->name ?? 'Account' }}
                    </a>
                      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="accountDropdown">
                        <li><a class="dropdown-item" href="{{ route('frontend.home') }}">Dashboard</a></li>
                        <li><a class="dropdown-item" href="#">My Orders</a></li>
                        <li>
                            <form action="{{ route('frontend.account.logout') }}" method="POST" class="dropdown-item m-0 p-0">
                                @csrf
                                <button type="submit" class="btn btn-link text-start w-100 text-danger px-3 py-2" style="text-decoration: none;">Logout</button>
                            </form>
                        </li>
                    </ul>
                </div>
                    @else
                    <a href="{{ route('frontend.account.login') }}" class="nav-link text-dark">Login</a>
                @endauth
				<form action="">
      			...
      			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
							...
							<li><a class="dropdown-item nav-link" href="{{route('frontend.shop' , [$category->slug,$sub_categories->slug])}}">{{$sub_categories->name}}</a></li>
                            @endforeach
						</ul>
                        @endif
					</li>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="footer-card">
					<h3>My Account</h3>
					<ul>
						<li><a href="{{route('frontend.account.login')}}" title="Sell">Login</a></li>
						<li><a href="{{route('frontend.account.register')}}" title="Advertise">Register</a></li>
...
function addToCart(id)
    {
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#cartMessage').html('<div class="alert alert-success">' + response.message + '</div>');
