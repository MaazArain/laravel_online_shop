                        ...
                        <div class="accordion accordion-flush" id="accordionExample">
                          ...
                          @if(!empty($categories) && $categories->count() > 0)
                              ...
                              <div class="accordion-item">
                                @if(!empty($category->sub_categories) && $category->sub_categories->count() > 0)
                                ...
                                @endif
                              @if(!empty($category->sub_categories) && $category->sub_categories->count() > 0)
                                <div id="collapseOne-{{ $key }}" class="accordion-collapse collapse {{ ($categorySelected)}}" aria-labelledby="headingOne-{{ $key }}" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="navbar-nav">
                                            @foreach ($category->sub_categories as $sub_category)
                                            <a href="{{route('frontend.shop' , [$category->slug , $sub_category->slug])}}" class="nav-item nav-link">{{ $sub_category->name }}</a>                                       
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    ...
                                    <a href="#" class="product-img">
                                        ...
                                        @else
                                        <img class="card-img-top" src="{{asset('admin-assets/img/photo2.png')}}" alt="">
                                        @endif
                                    </a>
